...
class Token:
    def __init__(self, token_type=None, lexeme=None, lineno=None):
...
class CodeGen:
    ...
    def add_output_function(self):
        # Add output function to symbol table with a special address that doesn't interfere
        from .symbol import Symbol
        output_symbol = Symbol(address="#output", lexeme='output', symbol_type=VOID, param_count=1)
        output_symbol.is_function = True
        self.symbol_table.scopes[0].append(output_symbol)
